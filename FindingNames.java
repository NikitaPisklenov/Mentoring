...
public class FindingNames {
    public static void main(String[] args) {
        ...
        //to remove dots and commas - replace.(",","")

        for (String word : words) {

            if (word.equalsIgnoreCase(name[0])) {

                rightsCount++;
            }
            if (word.equalsIgnoreCase(name[1])) {
                applyCount++;
            }

        }

        System.out.println("Amount of rights is " +rightsCount);
        System.out.println("Amount of apply is " +applyCount);
